...
from ..protocols import DataIndexProtocol

class IndexWithAliases(DataIndexProtocol):
...
class TokenMapIndex(DataIndexProtocol):
...
class MultiTreeIndex(DataIndexProtocol):
